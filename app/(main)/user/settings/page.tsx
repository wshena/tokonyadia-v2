      ...
      <ContentContainer>
        <div className="space-y-8">
              ...
              <div className="mt-3 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                  <h1 className="text-3xl font-bold md:text-4xl">
                    Pengaturan akun belanja kamu
                  </h1>
                  <p className="mt-3 text-sm leading-6 text-slate-200 md:text-base">
                    Kelola data profil, kontak utama, dan informasi penting
                    lainnya agar proses checkout, pengiriman, dan layanan purna
                    jual berjalan lebih lancar.
                  </p>
                </div>
          ...
          <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
            <div className="space-y-6">
              <article className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
                <div className="mb-5 flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-500">
                      Informasi ini membantu toko mengenali akunmu saat checkout
                      dan pengiriman.
                    </p>
                  </div>
                ...
                <div className="w-full flex items-center justify-end pt-6">
                  <button
                    ...
                    className="cursor-pointer rounded-xl px-4 py-2 text-sm font-semibold text-red-700 bg-red-50 transition-colors hover:bg-red-100"
                  >
                    Ubah
                  </button>
                </div>
              ...
              <article className="rounded-md border border-gray-200 bg-white p-6 shadow-sm">
                <div className="mb-5">
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-500">
                    Gunakan data yang akurat agar kurir dan tim support lebih
                    mudah membantu.
                  </p>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-2xl bg-amber-50 p-4">
                    ...
                    <p className="mt-2 font-semibold text-amber-900">
                      Siap digunakan untuk checkout
                    </p>
                  </div>
                  <div className="rounded-2xl bg-gray-50 p-4">
                    <p className="text-sm text-gray-500">Keamanan akun</p>
                    <p className="mt-2 font-semibold text-gray-900">
                      Dilindungi autentikasi
                    </p>
                  </div>
                </div>
              </article>
            ...
            <aside className="h-fit rounded-md border border-gray-200 bg-white p-5 shadow-sm xl:sticky xl:top-28">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Pantau status order dan riwayat transaksi.
                    </p>
                  </Link>
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Lanjutkan checkout dari produk yang tersimpan.
                    </p>
                  </Link>
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Temukan produk baru untuk belanja berikutnya.
                    </p>
                  </Link>
                </div>
              </div>
