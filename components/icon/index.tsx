...
export const NotificationBellIcon = ({ size, color, className }: IconProps) => {
  return <FaRegBell size={size} color={color} className={className} />;
};
...
export const PenIcon = ({ size, color, className }: IconProps) => {
  return <FaPenAlt size={size} color={color} className={className} />;
};

export const TrashIcon = ({ size, color, className }: IconProps) => {
  return <FaRegTrashCan size={size} color={color} className={className} />;
};

export const MinusIcon = ({ size, color, className }: IconProps) => {
  return <FaMinus size={size} color={color} className={className} />;
};

export const PlusIcon = ({ size, color, className }: IconProps) => {
  return <FaPlus size={size} color={color} className={className} />;
};

export const FullHeartIcon = ({ size, color, className }: IconProps) => {
  return <FaHeart size={size} color={color} className={className} />;
};

export const HeartIcon = ({ size, color, className }: IconProps) => {
  return <FaRegHeart size={size} color={color} className={className} />;
};
...
export const PinterestIcon = ({ size, color, className }: IconProps) => {
  return <FaPinterest size={size} color={color} className={className} />;
};
